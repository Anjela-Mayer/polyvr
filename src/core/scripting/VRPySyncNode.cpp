...
PyMethodDef VRPySyncNode::methods[] = {
    ...
    {"startInterface", PyWrap(SyncNode, startInterface, "updates this SyncNode", void) },
    {"addRemote", PyWrap(SyncNode, addRemote, "adds a SyncRemote, address and port", void, string) },
